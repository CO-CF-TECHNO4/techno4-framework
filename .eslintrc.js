const rules = {
  ...
  'import/no-unresolved': [2, { ignore: ['ssr-window', 'techno4-svelte', 'swiper/svelte'] }],
};
...
module.exports = {
  ...
  overrides: [
    ...
    // REACT Boonker
    {
      files: ['boonker/react/src/**/*.jsx', 'boonker/react/src/**/*.js'],
      rules: {
        ...rules,
    ...
    {
      files: ['boonker/svelte/src/**/*.svelte'],
      rules: {
        ...rules,
        'no-console': ['off'],
