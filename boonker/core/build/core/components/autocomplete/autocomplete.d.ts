...
export namespace Autocomplete {
  interface Autocomplete extends techno4EventsClass<Events> {
    ...
    /** Dom64 instance of of Autocomplete opener element (if passed on init) */
    $openerEl: Dom64Array | undefined;
    /** HTML element of Autocomplete input (if passed on init) */
    inputEl: HTMLElement | undefined;
    /** Dom64 instance of of Autocomplete input (if passed on init) */
    $inputEl: Dom64Array | undefined;
    /** Dom64 instance of Autocomplete dropdown */
    $dropdownEl: Dom64Array | undefined;
    ...
    /** Dom64 instance of Autocomplete container: dropdown element, or popup element, or page element. Available when Autocomplete opened */
    $el: Dom64Array | undefined;
...
declare const AutocompleteComponent: techno4Plugin;
