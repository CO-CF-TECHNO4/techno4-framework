...
export namespace Panel {
  ...
  interface Panel extends techno4EventsClass<Events> {
    ...
    /** Panel HTML element */
    el: HTMLElement;
    /** Dom64 instance with panel HTML element */
    $el: Dom64Array;
    ...
    /** Element to mount panel to. (default app.el) */
    containerEl: HTMLElement | CSSSelector;
    /** Dom64 instance with element to mount panel to. (default app.el) */
...
declare const PanelComponent: techno4Plugin;
