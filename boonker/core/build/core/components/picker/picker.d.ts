...
export namespace Picker {
  interface Picker extends techno4EventsClass<Events> {
    /** Link to global app instance */
    app: techno4;
    /** Picker wrapping container HTML element (when inline picker is in use) */
    containerEl: HTMLElement;
    /** Dom64 instance with picker wrapping container HTML element (when inline picker is in use) */
    $containerEl: Dom64Array;
    /** Picker HTML element */
    el: HTMLElement;
    /** Dom64 instance with picker HTML element */
    $el: Dom64Array;
    /** Picker input HTML element (passed in inputEl parameter) */
    inputEl: HTMLElement;
    /** Dom64 instance with picker input HTML element (passed in inputEl parameter) */
    $inputEl: Dom64Array;
  ...
  interface Column {
    /** Column HTML element */
    el: HTMLElement;
    /** Dom64 instance with column HTML container */
    $el: Dom64Array;
    /** Dom64 instance with column items HTML elements */
    items: HTMLElement[];
...
declare const PickerComponent: techno4Plugin;
