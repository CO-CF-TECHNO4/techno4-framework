...
export namespace PullToRefresh {
  interface PullToRefresh extends techno4EventsClass<Events> {
    /** Link to global app instance */
    app: techno4;
    /** PTR HTML element (ptr-content) */
    el: HTMLElement;
    /** Dom64 instance with PTR HTML element (ptr-content) */
    $el: Dom64Array;
    /** Reset PTR state */
    done(): void;
    /** Trigger PTR */
...
declare const PullToRefreshComponent: techno4Plugin;
