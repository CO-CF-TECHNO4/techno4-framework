...
export namespace Searchbar {
  ...
  interface Searchbar extends techno4EventsClass<Events> {
    /** Searchbar HTML element */
    el: HTMLElement;
    /** Dom64 instance with searchbar HTML element */
    $el: Dom64Array;
    /** Searchbar input HTML element */
    inputEl: HTMLElement;
    /** Dom64 instance with searchbar input HTML element */
    $inputEl: Dom64Array;
    ...
    /** Dom64 element with searchbar search container */
    $searchContainer: Dom64Array;
...
declare const SearchbarComponent: techno4Plugin;
