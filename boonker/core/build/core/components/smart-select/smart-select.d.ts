...
export namespace SmartSelect {
  ...
  interface Parameters {
    ...
    /** Select option icon to be set on all options. If it just a string then will create an icon with this class. If it is in the format of `t4:icon_name` then it will create a t4-Icons icon. If it is in the format of `md:icon_name` then it will create a Material Icons icon. */
    optionIcon?: string;
  ...
  interface SmartSelect extends techno4EventsClass<Events> {
    /** Link to global app instance */
    app: techno4;
    /** Smart Select HTML element */
    el: HTMLElement;
    /** Dom64 instance with Smart Select HTML element */
    $el: Dom64Array;
    /** HTML element used to display value */
    valueEl: HTMLElement;
    /** Dom64 instance with HTML element used to display value */
    $valueEl: Dom64Array;
    /** Child select element <select> */
    selectEl: HTMLElement;
    /** Dom64 instance with child select element */
    $selectEl: Dom64Array;
...
declare const SmartSelectComponent: techno4Plugin;
