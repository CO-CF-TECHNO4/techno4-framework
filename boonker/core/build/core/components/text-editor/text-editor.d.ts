...
export namespace TextEditor {
  ...
  interface TextEditor extends techno4EventsClass<Events> {
    /** Link to global app instance */
    app: techno4;
    /** Editor HTML element */
    el: HTMLElement;
    /** Dom64 instance with editor HTML element */
    $el: Dom64Array;
    /** Editor contenteditable content element */
    contentEl: HTMLElement;
    /** Dom64 instance with editor contenteditable content element */
    $contentEl: Dom64Array;
...
declare const TextEditorComponent: techno4Plugin;
