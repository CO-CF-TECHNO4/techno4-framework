...
export namespace Calendar {
  interface Calendar extends techno4EventsClass<Events> {
    /** Link to global app instance */
    app: techno4;
    /** Calendar wrapping container HTML element (when inline calendar is in use) */
    containerEl: HTMLElement;
    /** Dom64 instance with calendar wrapping container HTML element (when inline calendar is in use) */
    $containerEl: Dom64Array;
    /** Calendar HTML element */
    el: HTMLElement;
    /** Dom64 instance with calendar HTML element */
    $el: Dom64Array;
    /** Calendar input HTML element (passed in inputEl parameter) */
    inputEl: HTMLElement;
    /** Dom64 instance with calendar input HTML element (passed in inputEl parameter) */
    $inputEl: Dom64Array;
...
declare const CalendarComponent: techno4Plugin;
