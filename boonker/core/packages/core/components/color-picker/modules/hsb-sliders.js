...
export default {
  ...
  update(self) {
    ...
    self.hueRangeSlider.$el[0].style.setProperty('--t4-range-knob-color', `hsl(${hue}, 100%, 50%)`);
    self.saturationRangeSlider.$el[0].style.setProperty('--t4-range-knob-color', `hsl(${hslCurrent[0]}, ${hslCurrent[1] * 100}%, ${hslCurrent[2] * 100}%)`);
    self.brightnessRangeSlider.$el[0].style.setProperty('--t4-range-knob-color', `rgb(${brightness * 255}, ${brightness * 255}, ${brightness * 255})`);
