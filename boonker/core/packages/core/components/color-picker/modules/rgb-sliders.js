...
export default {
  ...
  update(self) {
    ...
    redRangeSlider.$el[0].style.setProperty('--t4-range-knob-color', `rgb(${rgb[0]}, ${rgb[1]}, ${rgb[2]})`);
    greenRangeSlider.$el[0].style.setProperty('--t4-range-knob-color', `rgb(${rgb[0]}, ${rgb[1]}, ${rgb[2]})`);
    blueRangeSlider.$el[0].style.setProperty('--t4-range-knob-color', `rgb(${rgb[0]}, ${rgb[1]}, ${rgb[2]})`);
