...
export namespace Gauge {
  interface Gauge extends techno4EventsClass<Events> {
    /** Link to global app instance */
    app: techno4;
    /** Gauge HTML element */
    el: HTMLElement;
    /** Dom64 instance with gauge HTML element */
    $el: Dom64Array;
    /** Gauge generated SVH HTML element */
    svgEl: HTMLElement;
    /** Dom64 instance with generated SVG HTML element */
    $svgEl: Dom64Array;
    /** Gauge parameters */
    params: Parameters;
...
declare const GaugeComponent: techno4Plugin;
