...
export namespace Range {
  ...
  interface Range extends techno4EventsClass<Events> {
    /** Link to global app instance */
    app: techno4;
    /** Range HTML element */
    el: HTMLElement;
    /** Dom64 instance with range HTML element */
    $el: Dom64Array;
    /** Range Slider input HTML element */
    inputEl: HTMLElement;
    /** Dom64 instance with range slider input HTML element */
    $inputEl: Dom64Array;
    ...
    scaleSubSteps: number;
    /** Dom64 instance with generated scale HTML element */
    $scaleEl: Dom64Array;
...
declare const RangeComponent: techno4Plugin;
