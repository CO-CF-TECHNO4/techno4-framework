...
export namespace Stepper {
  ...
  interface Stepper extends techno4EventsClass<Events> {
    /** Link to global app instance */
    app: techno4;
    /** Stepper HTML element */
    el: HTMLElement;
    /** Dom64 instance with stepper HTML element */
    $el: Dom64Array;
    /** Stepper min value */
    min: number;
    /** Stepper max value */
    ...
    inputEl: HTMLElement;
    /** Dom64 instance with stepper input HTML element */
    $inputEl: Dom64Array;
    /** Stepper value container HTML element */
    valueEl: HTMLElement;
    /** Dom64 instance with stepper value container HTML element */
    $valueEl: HTMLElement;
    /** Stepper parameters */
    params: Parameters;
...
declare const StepperComponent: techno4Plugin;
