...
export namespace Toast {
  ...
  interface Parameters {
    ...
    /** Toast icon HTML layout, e.g. <i class="t4-icons">house</i> or image <img src="path/to/icon.png"> */
    icon?: string;
    /** Toast inner text */
    text?: string;
  ...
  interface Toast extends techno4EventsClass<Events> {
    /** Link to global app instance */
    app: techno4;
    /** Toast HTML element */
    el: HTMLElement;
    /** Dom64 instance with toast HTML element */
    $el: Dom64Array;
    /** Toast parameters */
    params: Parameters;
...
declare const ToastComponent: techno4Plugin;
