    ...
    if (validUrl || $clickedLinkEl.hasClass('back')) {
      ...
      if (clickedLinkData.view && clickedLinkData.view === 'current') {
        ...
        if (!$clickedLinkEl.hasClass('back') && view && view.params.linksView) {
          if (typeof view.params.linksView === 'string') view = $(view.params.linksView)[0].t4View;else if (view.params.linksView instanceof ViewClass) view = view.params.linksView;
        }
      }
      if (!view) {
