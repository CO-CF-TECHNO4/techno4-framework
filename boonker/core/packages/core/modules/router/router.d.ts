...
export namespace Router {
  interface ModalRouteParameters {
    ...
    content?: string | HTMLElement | Dom64Array | HTMLElement[];
    /** Load page content via Ajax. */
    url?: string;
    /** Load page from passed techno4 Router Component */
  ...
  interface RouteParameters {
    ...
    master?: boolean | ((t4: techno4, router: Router) => boolean);
  ...
  interface Page {
    ...
    /** Page element */
    el: HTMLElement;
    /** Dom64 instance with Page element */
    $el: Dom64Array;
    /** Related navbar element for this page. Available only in iOS theme with dynamic navbar enabled. */
    navbarEl: HTMLElement;
    /** Dom64 instance with related navbar element for this page. Available only in iOS theme with dynamic navbar enabled. */
    $navbarEl: Dom64Array;
  ...
  interface Router extends techno4EventsClass<Events> {
    ...
    el: HTMLElement;
    /** Dom64 instance with router's view HTML element */
    $el: Dom64Array;
  ...
  interface DomEvents {
    ...
    'page:mounted': () => void;
    /** Event will be triggered after techno4 initialize required page's components and navbar */
    'page:init': () => void;
...
declare const RouterModule: techno4Plugin;
