...
export default () => {
  ...
  const onPageInit = () => {
    ...
    // Simple Dropdown
    autocompleteDropdownSimple.current = t4.autocomplete.create({
    ...
    autocompleteDropdownExpand.current = t4.autocomplete.create({
    ...
    autocompleteDropdownAll.current = t4.autocomplete.create({
    ...
    autocompleteDropdownPlaceholder.current = t4.autocomplete.create({
    ...
    autocompleteDropdownTypeahead.current = t4.autocomplete.create({
    ...
    autocompleteDropdownAjax.current = t4.autocomplete.create({
    ...
    // Dropdown with ajax data
    autocompleteDropdownAjaxTypeahead.current = t4.autocomplete.create({
    ...
    // Simple Standalone
    autocompleteStandaloneSimple.current = t4.autocomplete.create({
    ...
    // Standalone Popup
    autocompleteStandalonePopup.current = t4.autocomplete.create({
    ...
    // Multiple Standalone
    autocompleteStandaloneMultiple.current = t4.autocomplete.create({
      openIn: 'page', // open in page
    ...
    autocompleteStandaloneAjax.current = t4.autocomplete.create({
      openIn: 'page', // open in page
    ...
    autocompleteSearchbar.current = t4.autocomplete.create({
      openIn: 'dropdown',
