  ...
  <Page>
    ...
    <Card className="demo-card-header-pic">
      <CardHeader
        ...
        valign="bottom"
        style={{
          backgroundImage: 'url(https://cdn.techno4.io/placeholder/nature-1000x600-3.jpg)',
        }}
      >
    ...
    <Card className="demo-card-header-pic">
      <CardHeader
        ...
        valign="bottom"
        style={{
          backgroundImage: 'url(https://cdn.techno4.io/placeholder/people-1000x600-6.jpg)',
        }}
      >
        Journey To Mountains
      </CardHeader>
    ...
    <Card className="demo-facebook-card">
      <CardHeader className="no-border">
        <div className="demo-facebook-avatar">
          <img
            src="https://cdn.techno4.io/placeholder/people-68x68-1.jpg"
            width="34"
            height="34"
          />
        </div>
