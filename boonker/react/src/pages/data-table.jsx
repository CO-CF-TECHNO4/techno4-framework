        ...
        <thead>
          <tr>
            ...
            <th className="medium-only">
              <Icon
                ios="t4:chat_bubble_text_fill"
                aurora="t4:chat_bubble_text_fill"
                md="material:message"
              />{' '}
              Comments
            </th>
    ...
    <Card className="data-table data-table-init">
      <CardHeader>
        ...
        <div className="data-table-actions">
          <Link
            iconIos="t4:line_horizontal_3_decrease"
            iconAurora="t4:line_horizontal_3_decrease"
            iconMd="material:sort"
          />
          <Link
            iconIos="t4:ellipsis_vertical_circle"
            iconAurora="t4:ellipsis_vertical_circle"
    ...
    <Card className="data-table data-table-init">
      <CardHeader>
        ...
        <div className="data-table-header-selected">
          ...
          <div className="data-table-actions">
            <Link iconIos="t4:trash" iconAurora="t4:trash" iconMd="material:delete" />
            <Link
              iconIos="t4:ellipsis_vertical_circle"
              iconAurora="t4:ellipsis_vertical_circle"
              iconMd="material:more_vert"
          ...
          <tbody>
            <tr>
              ...
              <td className="actions-cell">
                <Link
                  iconIos="t4:square_pencil"
                  iconAurora="t4:square_pencil"
