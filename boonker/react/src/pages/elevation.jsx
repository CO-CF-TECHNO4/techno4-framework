...
import { Page, Navbar, Block, Row, Col } from 'techno4-react';
...
export default () => (
  <Page>
    ...
    <Block>
      ...
      <Row>
        <Col>
          <div className="elevation-demo elevation-6 elevation-hover-24 elevation-pressed-12 elevation-transition">
