    ...
    <Page onPageAfterIn={() => onPageAfterIn()}>
      ...
      <Block strong className="no-padding-horizontal" style={{ zIndex: 2000 }}>
        ...
        <Menu>
          ...
          <MenuItem style={{ marginLeft: 'auto' }} icont4="square_arrow_up" dropdown>
            <MenuDropdown right>
              <MenuDropdownItem href="#">
                <span>Share on Facebook</span>
                <Icon className="margin-left" t4="logo_facebook" />
              </MenuDropdownItem>
              <MenuDropdownItem href="#">
                <span>Share on Twitter</span>
                <Icon className="margin-left" t4="logo_twitter" />
              </MenuDropdownItem>
            </MenuDropdown>
          </MenuItem>
      ...
      <Card>
        <CardContent padding={false}>
          ...
          <Menu style={{ position: 'absolute', left: '0px', top: '6px' }}>
            <MenuItem href="#" icont4="zoom_in"></MenuItem>
            <MenuItem href="#" icont4="zoom_out"></MenuItem>
