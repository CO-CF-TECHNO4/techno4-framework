...
export default () => {
  ...
  useEffect(() => {
    t4ready(() => {
      messagebar.current = t4.messagebar.get('.messagebar');
    });
  });
  ...
  const handleAttachment = (e) => {
    const index = t4.$(e.target).parents('label.checkbox').index();
  ...
  return (
    <Page>
      ...
      >
        <Link
          iconIos="t4:camera_fill"
          iconAurora="t4:camera_fill"
        ...
        />
        <Link
          iconIos="t4:arrow_up_circle_fill"
          iconAurora="t4:arrow_up_circle_fill"
