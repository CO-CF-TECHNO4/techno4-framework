...
import { Navbar, Page, Block, BlockTitle, List, ListInput, t4 } from 'techno4-react';
...
export default () => {
  ...
  const onPageInit = () => {
    ...
    // iOS Device picker
    pickerDevice.current = t4.picker.create({
    ...
    pickerDescribe.current = t4.picker.create({
    ...
    pickerDependent.current = t4.picker.create({
    ...
    // Custom Toolbar
    pickerCustomToolbar.current = t4.picker.create({
    ...
    // Inline date-time
    pickerInline.current = t4.picker.create({
