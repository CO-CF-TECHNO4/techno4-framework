...
<Page>
  ...
  <Card class="demo-card-header-pic">
    <CardHeader
      class="no-border"
      valign="bottom"
      style="background-image: url(https://cdn.techno4.io/placeholder/nature-1000x600-3.jpg)"
  ...
  <Card class="demo-card-header-pic">
    <CardHeader
      class="no-border"
      valign="bottom"
      style="background-image: url(https://cdn.techno4.io/placeholder/people-1000x600-6.jpg)"
    >Journey To Mountains</CardHeader>
    <CardContent>
      <p class="date">Posted on January 21, 2015</p>
      <p>Quisque eget vestibulum nulla. Quisque quis dui quis ex ultricies efficitur vitae non felis. Phasellus quis nibh hendrerit...</p>
  ...
  <Card class="demo-facebook-card">
    <CardHeader class="no-border">
      <div class="demo-facebook-avatar"><img src="https://cdn.techno4.io/placeholder/people-68x68-1.jpg" width="34" height="34"/></div>
      <div class="demo-facebook-name">John Doe</div>
      <div class="demo-facebook-date">Monday at 3:47 PM</div>
    </CardHeader>
    <CardContent padding={false}>
      <img src="https://cdn.techno4.io/placeholder/nature-1000x700-8.jpg" width="100%"/>
    </CardContent>
  ...
  <Card class="demo-facebook-card">
    ...
    <CardContent>
      <p>What a nice photo i took yesterday!</p><img src="https://cdn.techno4.io/placeholder/nature-1000x700-8.jpg" width="100%"/>
    ...
    <CardContent padding={false}>
      <List mediaList>
        <ListItem
          ...
          subtitle="Beatles"
        >
          <img slot="media" src="https://cdn.techno4.io/placeholder/fashion-88x88-4.jpg" width="44"/>
        </ListItem>
        <ListItem
          title="Don't Stop Me Now"
          subtitle="Queen"
        >
          <img slot="media" src="https://cdn.techno4.io/placeholder/fashion-88x88-5.jpg" width="44"/>
        </ListItem>
        <ListItem
          title="Billie Jean"
          subtitle="Michael Jackson"
        >
          <img slot="media" src="https://cdn.techno4.io/placeholder/fashion-88x88-6.jpg" width="44"/>
        </ListItem>
      </List>
    </CardContent>
    <CardFooter>
