    ...
    <table>
      <thead>
        <tr>
          ...
          <th class="numeric-cell">Carbs</th>
          <th class="numeric-cell">Protein (g)</th>
          <th class="medium-only"><Icon ios="t4:chat_bubble_text_fill" aurora="t4:chat_bubble_text_fill" md="material:message"></Icon> Comments</th>
        </tr>
      </thead>
      <tbody>
        <tr>
  ...
  <Card class="data-table data-table-init">
    <CardHeader>
      ...
      <div class="data-table-actions">
        <Link iconIos="t4:line_horizontal_3_decrease" iconAurora="t4:line_horizontal_3_decrease" iconMd="material:sort"></Link>
        <Link iconIos="t4:ellipsis_vertical_circle" iconAurora="t4:ellipsis_vertical_circle" iconMd="material:more_vert"></Link>
      </div>
    </CardHeader>
  ...
  <Card class="data-table data-table-init">
    <CardHeader>
      ...
      <div class="data-table-header-selected">
        ...
        <div class="data-table-actions">
          <Link iconIos="t4:trash" iconAurora="t4:trash" iconMd="material:delete"></Link>
          <Link iconIos="t4:ellipsis_vertical_circle" iconAurora="t4:ellipsis_vertical_circle" iconMd="material:more_vert"></Link>
        </div>
      </div>
    </CardHeader>
        ...
        <tbody>
          <tr>
            ...
            <td class="actions-cell">
              <Link iconIos="t4:square_pencil" iconAurora="t4:square_pencil" iconMd="material:edit"></Link>
              <Link iconIos="t4:trash" iconAurora="t4:trash" iconMd="material:delete"></Link>
            </td>
          </tr>
          <tr>
