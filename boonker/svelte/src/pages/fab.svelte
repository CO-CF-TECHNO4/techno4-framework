<script>
  import { Navbar, Page, Block, Fab, FabButton, FabButtons, Icon } from 'techno4-svelte';
</script>
...
<Page>
  ...
  <Fab position="right-top">
    <Icon ios="t4:add" aurora="t4:add" md="material:add" />
    <Icon ios="t4:close" aurora="t4:close" md="material:close" />
