...
<Page>
  ...
  <!-- prettier-ignore -->
  <Block strong>
    <p>techno4 comes with the premium and free <a href="https://techno4.io/icons/" class="external" target="_blank">techno4 Icons</a> iOS-icons font developed specially to be used with iOS theme of techno4. As for Material theme we recommend to use great-designed <a href="https://material.io/icons/" class="external" target="_blank">Material Icons</a> font. Both of these fonts use a typographic feature called <a href="http://alistapart.com/article/the-era-of-symbol-fonts" class="external" target="_blank">ligatures</a>. It’s easy to incorporate icons into your app. Here’s a small example:</p>
    <p><code>&lt;i class="t4-icons"&gt;house&lt;/i&gt;</code> - <i class="t4-icons">house</i></p>
  ...
  <BlockHeader>
    <Segmented strong>
      <Button tabLink="#tab-t4" tabLinkActive>t4 Icons</Button>
