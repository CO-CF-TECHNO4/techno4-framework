<template>
  <t4-page>
    <t4-navbar title="Color Picker" back-link="Back"></t4-navbar>

    <t4-block strong>
      <p>
        techno4 comes with ultimate modular Color Picker component that allows to create color
        picker with limitless combinations of color modules.
      </p>
    </t4-block>

    <t4-block-title>Color Wheel</t4-block-title>
    <t4-block-header>Minimal example with color wheel in Popover</t4-block-header>
    ...
    <t4-block-title>Saturation-Brightness Spectrum</t4-block-title>
    <t4-block-header>SB Spectrum + Hue Slider in Popover</t4-block-header>
    <t4-list no-hairlines-md>
      <t4-list-input
    ...
    <t4-block-title>Hue-Saturation Spectrum</t4-block-title>
    <t4-block-header>HS Spectrum + Brightness Slider in Popover</t4-block-header>
    <t4-list no-hairlines-md>
      <t4-list-input
    ...
    <t4-block-title>RGB Sliders</t4-block-title>
    <t4-block-header>RGB sliders with labels and values in Popover</t4-block-header>
    <t4-list no-hairlines-md>
      <t4-list-input
    ...
    <t4-block-title>RGBA Sliders</t4-block-title>
    <t4-block-header>RGB sliders + Alpha Slider with labels and values in Popover</t4-block-header>
    <t4-list no-hairlines-md>
      <t4-list-input
    ...
    <t4-block-title>HSB Sliders</t4-block-title>
    <t4-block-header>HSB sliders with labels and values in Popover</t4-block-header>
    <t4-list no-hairlines-md>
      <t4-list-input
    ...
    <t4-block-title>RGB Bars</t4-block-title>
    <t4-block-header
      >RGB bars with labels and values in Popover on tablet and in Popup on phone</t4-block-header
    >
    <t4-list no-hairlines-md>
      <t4-list-input
    ...
    <t4-block-title>Palette</t4-block-title>
    <t4-block-header
      >Palette opened in Sheet modal on phone and Popover on larger screens</t4-block-header
    >
    <t4-list no-hairlines-md>
      <t4-list-input
    ...
    <t4-block-title>Inline Color Picker</t4-block-title>
    <t4-block-header>SB Spectrum + HSB Sliders</t4-block-header>
...
export default {
  ...
  mounted() {
    ...
    self.colorPickerInline = t4.colorPicker.create({
