<template>
  <t4-page>
    <t4-navbar title="Floating Action Button Morph" back-link="Back"></t4-navbar>
    <t4-toolbar tabbar labels bottom class="fab-morph-target">
      <t4-link
        tab-link
        tab-link-active
        icon-ios="t4:envelope_fill"
        icon-aurora="t4:envelope_fill"
        icon-md="material:email"
        text="Inbox"
      />
      <t4-link
        tab-link
        icon-ios="t4:calendar_fill"
        icon-aurora="t4:calendar_fill"
        icon-md="material:today"
        text="Calendar"
      />
      <t4-link
        tab-link
        icon-ios="t4:cloud_upload_fill"
        icon-aurora="t4:cloud_upload_fill"
        icon-md="material:file_upload"
        text="Upload"
      />
    </t4-toolbar>
    <t4-fab position="right-bottom" morph-to=".toolbar.fab-morph-target">
      <t4-icon ios="t4:plus" aurora="t4:plus" md="material:add"></t4-icon>
    </t4-fab>
    <t4-fab position="left-bottom" morph-to=".demo-fab-sheet.fab-morph-target">
      <t4-icon ios="t4:plus" aurora="t4:plus" md="material:add"></t4-icon>
    </t4-fab>
    <t4-fab position="center-bottom" morph-to=".demo-fab-fullscreen-sheet.fab-morph-target">
      <t4-icon ios="t4:plus" aurora="t4:plus" md="material:add"></t4-icon>
    </t4-fab>
    <template #fixed>
      ...
      <div class="demo-fab-fullscreen-sheet fab-morph-target">
        <t4-block-title>Choose Something</t4-block-title>
