<template>
  <t4-page :page-content="false" @page:beforeremove="onPageBeforeRemove" @page:init="onPageInit">
    <t4-navbar title="Picker" back-link="Back"></t4-navbar>
...
<script>
import { t4Navbar, t4Page, t4 } from 'techno4-vue';
...
export default {
  ...
  methods: {
    onPageInit() {
      ...
      // iOS Device picker
      self.pickerDevice = t4.picker.create({
      ...
      self.pickerDescribe = t4.picker.create({
      ...
      self.pickerDependent = t4.picker.create({
      ...
      // Custom Toolbar
      self.pickerCustomToolbar = t4.picker.create({
      ...
      // Inline date-time
      self.pickerInline = t4.picker.create({
