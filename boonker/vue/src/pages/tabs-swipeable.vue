<template>
  <t4-page :page-content="false">
    <t4-navbar title="Swipeable Tabs" back-link="Back"></t4-navbar>
    <t4-toolbar bottom tabbar>
...
<script>
import { t4Navbar, t4Page, t4Block, t4Tabs, t4Tab, t4Link, t4Toolbar } from 'techno4-vue';
