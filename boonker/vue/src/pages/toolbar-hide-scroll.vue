<template>
  <t4-page hide-toolbar-on-scroll>
    <t4-navbar title="Hide Toolbar On Scroll" back-link="Back"></t4-navbar>
    <t4-toolbar bottom>
...
<script>
import { t4Navbar, t4Page, t4Toolbar, t4Link, t4Block } from 'techno4-vue';
