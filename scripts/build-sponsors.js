...
const getSponsors = () => {
  ...
  try {
    const localPath = path.resolve(
      __dirname,
      '../../techno4-website/src/pug/sponsors/sponsors.json',
    );
  ...
  return new Promise((resolve, reject) => {
    https
      .get('https://techno4.io/sponsors/sponsors.json', (resp) => {
        let data = '';
            ...
            .map((item) =>
              !item
                ...
                : [
                    ...
                    `        <img src="https://techno4.io/i/sponsors/${item.image}" alt="${item.title}" width="160">`,
                    `      </a>`,
                    `    </td>`,
                  ].join('\n'),
            )
