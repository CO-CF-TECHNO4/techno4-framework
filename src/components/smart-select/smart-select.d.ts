...
export namespace SmartSelect {
  ...
  interface Parameters {
    ...
    /** Select option icon to be set on all options. If it just a string then will create an icon with this class. If it is in the format of `t4:icon_name` then it will create a F7-Icons icon. If it is in the format of `md:icon_name` then it will create a Material Icons icon. */
    optionIcon?: string;
