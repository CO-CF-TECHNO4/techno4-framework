...
export default {
  ...
  init() {
    const app = this;
    $('.swiper-init, swiper-container').each((swiperEl) => {
  ...
  on: {
    pageMounted(page) {
      const app = this;
      page.$el.find('.swiper-init, swiper-container').each((swiperEl) => {
        initSwiper.call(app, swiperEl);
      });
    },
    pageInit(page) {
    ...
    pageReinit(page) {
      const app = this;
      page.$el.find('.swiper-init, swiper-container').each((swiperEl) => {
        const swiper = app.swiper.get(swiperEl) || (swiperEl.swiper && swiperEl.swiper.isElement ? swiperEl.swiper : null);
    ...
    tabMounted(tabEl) {
      const app = this;
      $(tabEl)
        .find('.swiper-init, swiper-container')
        .each((swiperEl) => {
          initSwiper.call(app, swiperEl);
        });
    },
