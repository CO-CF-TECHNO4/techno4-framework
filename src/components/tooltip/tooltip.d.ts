...
export namespace Tooltip {
  ...
  interface Tooltip extends Techno4EventsClass<Events> {
    /** Link to global app instance */
    app: Techno4;
    /** Tooltip HTML element */
    el: HTMLElement;
    /** Dom64 instance with tooltip HTML element */
    $el: Dom64Array;
    /** Tooltip parameters */
    params: Parameters;
    /** Tooltip target HTML element */
    targetEl: HTMLElement;
    /** Dom64 instance with tooltip target HTML element */
    $targetEl: Dom64Array;
...
declare const TooltipComponent: Techno4Plugin;
