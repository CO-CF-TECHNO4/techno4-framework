...
export namespace ColorPicker {
  ...
  interface ColorPicker extends techno4EventsClass<Events> {
    /** Link to global app instance */
    app: techno4;
    /** Color Picker wrapping container HTML element (when inline Color Picker is in use) */
    containerEl: HTMLElement;
    /** Dom64 instance with Color Picker wrapping container HTML element (when inline Color Picker is in use) */
    $containerEl: Dom64Array;
    /** Color Picker HTML element */
    el: HTMLElement;
    /** Dom64 instance with Color Picker HTML element */
    $el: Dom64Array;
    /** Color Picker input HTML element (passed in inputEl parameter) */
    inputEl: HTMLElement;
    /** Dom64 instance with Color Picker input HTML element (passed in inputEl parameter) */
    $inputEl: Dom64Array;
    /** Color Picker target HTML element (passed in targetEl parameter) */
    targetEl: HTMLElement;
    /** Dom64 instance with Color Picker target HTML element (passed in targetEl parameter) */
    $targetEl: Dom64Array;
    /** Object with value */
...
declare const ColorPickerComponent: techno4Plugin;
