...
export namespace ListIndex {
  interface ListIndex extends techno4EventsClass<Events> {
    /** Link to global app instance */
    app: techno4;
    /** List index HTML element */
    el: HTMLElement;
    /** Dom64 instance with list index HTML element */
    $el: Dom64Array;
    /** Dynamically created inner <ul> HTML element */
    ul: HTMLElement;
    /** Dom64 instance with dynamically created inner <ul> HTML element */
    $ul: Dom64Array;
    /** Related List HTML element, passed in listEl parameter */
    listEl: HTMLElement;
    /** Dom64 instance with related List HTML element, passed in listEl parameter */
    $listEl: Dom64Array;
...
declare const ListIndexComponent: techno4Plugin;
