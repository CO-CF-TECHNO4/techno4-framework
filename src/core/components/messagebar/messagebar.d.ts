...
export namespace Messagebar {
  interface Messagebar extends techno4EventsClass<Events> {
    /** Messagebar HTML element. */
    el: HTMLElement;
    /** Dom64 element with messagebar HTML element. */
    $el: Dom64Array;
    /** Messagebar textarea HTML element */
    textareaEl: HTMLTextAreaElement;
    /** Dom64 element with messagebar textarea HTML element */
    $textareaEl: Dom64Array;
...
declare const MessagebarComponent: techno4Plugin;
