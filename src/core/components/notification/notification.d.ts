...
export namespace Notification {
  interface Notification extends techno4EventsClass<Events> {
    /** Link to global app instance */
    app: techno4;
    /** Notification HTML element */
    el: HTMLElement;
    /** Dom64 instance with notification HTML element */
    $el: Dom64Array;
  ...
  interface Parameters {
    ...
    /** Notification icon HTML layout, e.g. <i class="t4-icons">house</i> or image <img src="path/to/icon.png">. */
    icon?: string;
    /** Notification title. */
    title?: string;
...
declare const NotificationComponent: techno4Plugin;
