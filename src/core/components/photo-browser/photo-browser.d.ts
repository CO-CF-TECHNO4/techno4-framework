...
export namespace PhotoBrowser {
  ...
  interface PhotoBrowser extends techno4EventsClass<Events> {
    /** Link to global app instance */
    app: techno4;
    /** Photo Browser HTML element */
    el: HTMLElement;
    /** Dom64 instance with Photo Browser HTML element */
    $el: Dom64Array;
...
declare const PhotoBrowserComponent: techno4Plugin;
