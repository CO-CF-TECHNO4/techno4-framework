...
export namespace View {
  interface View extends techno4EventsClass<Events> {
    /** Link to global app instance */
    app: techno4;
    /** View HTML element */
    el: HTMLElement;
    /** Dom64 instance with view HTML element */
    $el: Dom64Array;
  ...
  interface Parameters {
    ...
    /**	Set to true when your server cofigured to respond with content that matches to requested URL (e.g. using with server-side rendering frameworks like Nuxt.js, Next.js, and others). Also must be enabled when used in techno4-React/Vue/Svelte. By default disabled */
...
declare const ViewComponent: techno4Plugin;
