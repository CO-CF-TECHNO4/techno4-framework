...
export namespace VirtualList {
  ...
  interface VirtualList extends techno4EventsClass<Events> {
    items: any[];
    filteredItems: any[];
    domCache: object;
    /** Virtual list target list block element */
    el: HTMLElement;
    /** Dom64 instance of target list block element */
    $el: Dom64Array;
    /** Parameters passed on list initialization */
    params: Parameters;
    /** Parent "page-content" element */
    pageContentEl: HTMLElement;
    /** Dom64 instance of parent "page-content" element */
    $pageContentEl: Dom64Array;
...
declare const VirtualListComponent: techno4Plugin;
