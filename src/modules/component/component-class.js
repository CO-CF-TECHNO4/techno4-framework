...
class Component {
  ...
  getComponentContext(includeHooks) {
    const ctx = {
      $f7route: this.context.f7route || this.context.t4route,
      $f7router: this.context.f7router || this.context.t4router,
      $t4route: this.context.t4route || this.context.f7route,
      $t4router: this.context.t4router || this.context.f7router,
      $h,
      $,
      $id: this.id,
      $t4: this.t4,
      $f7: this.t4,
      $t4ready: this.f7ready ? this.f7ready.bind(this) : undefined,
      $f7ready: this.f7ready ? this.f7ready.bind(this) : undefined,
      $theme: this.theme,
