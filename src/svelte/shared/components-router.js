...
export default {
  proto: {
    ...
    pageComponentLoader({ routerEl, component, options, resolve, reject }) {
      ...
      const el = routerEl;
      let viewRouter;
      app.t4routers.views.forEach((data) => {
      ...
      function onDidUpdate(componentRouterData) {
        ...
        app.t4events.off('viewRouterDidUpdate', onDidUpdate);
      ...
      app.t4events.on('viewRouterDidUpdate', onDidUpdate);
    ...
    tabComponentLoader({ tabEl, component, options, resolve, reject } = {}) {
      ...
      let tabRouter;
      app.t4routers.tabs.forEach((tabData) => {
      ...
      function onDidUpdate(componentRouterData) {
        ...
        app.t4events.off('tabRouterDidUpdate', onDidUpdate);
      ...
      app.t4events.on('tabRouterDidUpdate', onDidUpdate);
    ...
    modalComponentLoader({ component, options, resolve, reject } = {}) {
      const router = this;
      const modalsRouter = app.t4routers.modals;
      ...
      function onDidUpdate() {
        if (resolved) return;
        app.t4events.off('modalsRouterDidUpdate', onDidUpdate);
      ...
      app.t4events.on('modalsRouterDidUpdate', onDidUpdate);
